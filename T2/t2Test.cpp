...
check("min_asm(1, 2, 3)", min_asm(1, 2, 3), 1);
check("min_asm(3, 1, 2)", min_asm(3, 1, 2), 1);
check("min_asm(2, 3, 1)", min_asm(2, 3, 1), 1);
check("min_asm(-1, -2, -3)", min_asm(-1, -2, -3), -3);
check("min_asm(-3, -1, -2)", min_asm(-3, -1, -2), -3);
check("min_asm(-2, -3, -1)", min_asm(-2, -3, -1), -3);
check("min_asm(-1, 2, 3)", min_asm(-1, 2, 3), -1);
check("min_asm(3, -1, 2)", min_asm(3, -1, 2), -1);
check("min_asm(2, 3, -1)", min_asm(2, 3, -1), -1);
